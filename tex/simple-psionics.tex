...
% Ensure the graphics path is set correctly (after loading graphicx)
\usepackage{graphicx}
% Search both from repo root and from the tex/ working directory
...
\begin{titlepage}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    ...
    \node[anchor=south west] at ([xshift=0.5in,yshift=0.5in]current page.south west) {
      \includegraphics[width=1.25in]{DMsGuildProductLogoLarge.png}
    };
  \end{tikzpicture}
\end{titlepage}
\restoregeometry
...
Choose a spellcasting ability between Charisma and Wisdom, but discuss with the DM.
\footnote{For instance, in a setting where psionics is developed through meditation and mental discipline, Wisdom might be the best choice, but if the character is born with the ability, Charisma might be more appropriate.}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\columnwidth]{ce5c3ddb-5c68-4fb6-8130-ca00fe9ae04a.png}
  \caption{Telekinesis kiddo in action. Generated using ChatGPT.}
  \label{fig:telekinesis}
\end{figure}
...
Telepathy is a collection of five feats, and players can take as many as they want.
Choose a spellcasting ability between Charisma and Wisdom, but discuss with the DM.
\footnote{For instance, in a setting where psionics is developed through meditation and mental discipline, Wisdom might be the best choice, but if the character is born with the ability, Charisma might be more appropriate.}
Constitution saving throw DCs are rolled after each use.
If there is a duration, roll the saving throw at the end of the duration.
...
Note that telepathy can be very powerful in social situations,
so the DM should consider the implications of allowing these feats in the campaign setting.
These feats do not give any bonuses to skills, to balance some of the power of telepathy.
In literature, a telepath (like Professor X, Kilgrave or The Mule from the Foundation, are typically otherwise fairly powerless individuals,
so I wanted to reflect that in the design of these feats.)\par


\subsection*{Detecting Telepathy}

All of the effects that change behaviour can be noticed by a somebody close to the target, such as friends, neighbours, and family.
For most powers, the Passive Perception of the observer needs to beat the spell attack bonus (8 + proficiency + spellcasting ability modifier) of the telepathic caster to notice.\par
If the observer succeeds, they can tell that something is wrong, but not necessarily what.
\footnote{In a setting where psychic powers are common, they may know immediately, but in a setting where they are rare, it might take some time to figure out what is happening. Consider Eberron as an example: somebody from Breland is not necessarily going to recognize an Inspired power, but a Kalashtar likely will.}
This is going to be a tell-tale sign for most powers, eyes going blank, or a monotone voice.\par

The exception is \emph{Command}, \emph{Dominate Person} and \emph{Dominate Monster} - these spells create a visible sign on the target, such as eyes going completely black, etc\dots
They do not require a roll by observer, they will immediately know something is wrong.
In all cases of an observer detecting, they will not necessarily know who the telepath is (unless there is a good reason to suspect the person)\par

Finally, \emph{Calm Emotions} is not detectable at all.\par
...
Your spellcasting ability for this cantrip is Charisma or Wisdom, depending on your choice.
...
without requiring verbal or somatic components. However, after each use, you must roll a Constitution saving throw (DC 12) or suffer one level of exhaustion.
\paragraph*{Calm Emotions} You can cast \emph{Calm Emotions} at will,
without requiring verbal or somatic components. However, after each use, you must roll a Constitution saving throw (DC 8) or suffer one level of exhaustion.
This is the only power that has a lower difficulty, since it is not as directly manipulative as the others.


\begin{figure}[htbp]
  \centering
  \includegraphics[width=\columnwidth]{deffd1a3-5914-4a95-b043-b81dd2d44be4.png}
  \caption{Who is controlling whom? Generated using ChatGPT.}
  \label{fig:telepathy}
\end{figure}
...
I focused on spells that start or control a fire, and left out the projectile spells.
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\columnwidth]{497a9086-325c-4204-9022-0d567b38713e.png}
  \caption{Bullying is Chaotic Evil. Generated using ChatGPT.}
  \label{fig:telepathy}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\columnwidth]{9df853d4-0b21-40c3-a3db-a345926f44eb.png}
  \caption{She is making sure that the cold chain is not broken. Generated using ChatGPT.}
  \label{fig:telepathy}
\end{figure}
