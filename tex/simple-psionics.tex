...
You can now can any one of the spells in the Prerequisite feats above
a number of times equal to your spellcasting ability modifier + you Constitution modifier (minimum of once),
...
Your spellcasting abiity for Pyrokinesis is Charisma.
Constitution saving throw DCs are rolled after each use.
If there is a duration, roll the saving throw at the end of the duration.
...
\paragraph*{Product Flame Cantrip} You can cast \emph{Produce Flame} at will,
...
However, you can only create fire effects with it - so you can only ``beckon fire'' and ``scult'' only fire.
...
\paragraph*{Ability Score Increase} Increase either your Constitution or Charisma by 1, to a maximum of 20.
...
Your spellcasting abiity for Cryokinesis can be Charisma, Wisdom or cold hard Intelligence.
Choose, and use it for all of the spell effects granted by that feat.\par
