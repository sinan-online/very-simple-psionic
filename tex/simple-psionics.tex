...
For instance, the hard-to-detect invisible \emph{Mage Hand} ability can pose challenges where players are able to circumvent challenges.
In particular, telepathy is very powerful, and probably not the best party composition for usual adventures.\par
